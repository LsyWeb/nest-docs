...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-3.png)

![](http://static.liushuaiyang.com/nest-docs/image/第79章-4.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-5.png)
...
npm run start:dev
```
![](http://static.liushuaiyang.com/nest-docs/image/第79章-6.png)

访问 http://localhost:3000 可以看到 hello world，代表服务器跑成功了：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-7.png)

然后在 AppController 添加一个 stream 接口：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-8.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第79章-9.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-10.png)

然后把 react 项目 index.tsx 里这几行代码删掉，它会导致额外的渲染：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-11.png)

执行 npm run start

因为 3000 端口被占用了，它会跑在 3001：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-12.png)

浏览器访问下：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-13.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-14.png)

然后在 EventStream 里可以看到每一次收到的消息：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-17.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第79章-20.png)

测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-21.png)
...
console.log(buffer);
```
![](http://static.liushuaiyang.com/nest-docs/image/第79章-22.png)

而 Buffer 有个 toJSON 方法：

![](http://static.liushuaiyang.com/nest-docs/image/第79章-23.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第79章-24.png)

![](http://static.liushuaiyang.com/nest-docs/image/第79章-25.png)
