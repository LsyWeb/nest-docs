...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-2.png)

但是失败的响应是这样：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-4.png)

在 Guard、handler、interceptor 等处理逻辑里 throw http 异常，都会被 ExceptionFilter 处理成相应的响应。

![](http://static.liushuaiyang.com/nest-docs/image/第89章-5.png)

![](http://static.liushuaiyang.com/nest-docs/image/第89章-6.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-8.png)

然后把 LoginGuard 里的异常改成 UnLoginException

![](http://static.liushuaiyang.com/nest-docs/image/第89章-9.png)

测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-10.png)

现在当你不带 token 访问 /aaa 的时候，返回的就是自己定义的格式了。

搜索下之前代码里抛的异常：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-11.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-13.png)

这样，所有的代码都不用修改，返回的响应就已经变了：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-14.png)

![](http://static.liushuaiyang.com/nest-docs/image/第89章-15.png)

所以，如果你只是想修改默认的响应格式，直接定义个 catch HttpException 的 filter 就好了。

但这样其实还有个问题：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-17.png)

在 postman 里再次请求这个接口，代码会在断点处断住：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-18.png)

可以看到，这时候 message 并不是具体的错误，具体的错误在 response.message 里：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-19.png)

所以我们可以这样改：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-20.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-21.png)

这样，错误显示就对了。

然后我们实现冻结用户的接口，冻结的用户不能预定会议室。

![](http://static.liushuaiyang.com/nest-docs/image/第89章-22.png)

这个接口非常简单，就是修改一个字段：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-24.png)

![](http://static.liushuaiyang.com/nest-docs/image/第89章-25.png)
...
select * from users
```
![](http://static.liushuaiyang.com/nest-docs/image/第89章-26.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-27.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第89章-28.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-29.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-30.png)

![](http://static.liushuaiyang.com/nest-docs/image/第89章-31.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-32.png)

没有传 pageNo 的时候设置为 1，没有传 pageSize 的时候设置为 2。

测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-33.png)

现在传入 pageNo 和 pageSize 就可以查询出对应的数据，还有总条数：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-34.png)

服务端打印了两条 sql：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-35.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-36.png)

当然，如果你需要对返回的数据再做一些变换，这时候可以封装个 vo 对象。

用户列表的需求除了分页外，还需要支持根据 username、nickName、email 的搜索：

![](http://static.liushuaiyang.com/nest-docs/image/第89章-37.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第89章-38.png)

当我传 nickName 包含“里”的时候，服务端查询到数据只有一条。

![](http://static.liushuaiyang.com/nest-docs/image/第89章-39.png)
