...
```
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-1.png)

在 docker desktop 里把 mysql 的容器跑起来：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-2.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-3.png)

刷新可以看到这个 database

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-4.png)

用户模块涉及到这些表：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-5.png)

我们创建下它们的 entity：

先在 nest-cli.json 里添加 generateOptions，设置 spec 为 false

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-6.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-7.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-8.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-9.png)

我们去数据库看下：

users 表没啥问题：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-10.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-11.png)

permissions 表：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-12.png)

还有两个中间表：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-13.png)

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-14.png)

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-15.png)

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-16.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-17.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-18.png)
```javascript
{
    "username": "guang",
    "nickName": "神说要有光",
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-19.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-20.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-21.png)

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-22.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-23.png)

注册的逻辑是这样的：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-24.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-25.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-26.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-27.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-28.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-29.png)

因为还没实现发送邮箱验证码的逻辑，这里我们手动在 redis 添加一个 key：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-30.png)

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-31.png)

测试下：

带上错误的验证码，返回验证码不正确；

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-32.png)

带上正确的验证码，返回注册成功：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-33.png)

这时可以在数据库里看到这条记录：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-34.png)
...
```
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-35.png)
...
![](./image/第86章—会议室预订系统：用户管理模块--用户注册-39.png)

邮件发送成功：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-40.png)

redis 里也保存了邮箱地址对应的验证码：

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-41.png)

这样整个注册的流程就完成了。

![](./image/第86章—会议室预订系统：用户管理模块--用户注册-42.png)
