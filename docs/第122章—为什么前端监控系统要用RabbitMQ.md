...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-1.png)

那就用现在的数据库，如何保证面对大量并发请求的时候，服务不崩呢？

答案就是消息队列，比如常用的 RabbitMQ：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-2.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-3.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-4.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-5.png)

这个版本是有 web 管理界面的。

点击 run：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-6.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-7.png)

就可以在浏览器访问 http://localhost:15672 了：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-8.png)

这就是它的 web 管理界面。

输入 guest、guest 进入管理页面：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-9.png)
...
npm init -y
```
![](./image/第122章—为什么前端监控系统要用RabbitMQ-10.image#?w=802&h=660&s=130464&e=png&b=010101.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-11.image#?w=674&h=454&s=62197&e=png&b=1f1f1f.png)

![](./image/第122章—为什么前端监控系统要用RabbitMQ-12.png)

之后就可以在管理界面看到这个队列了：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-13.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-14.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-15.png)
...
node ./src/producer.js
```
![](./image/第122章—为什么前端监控系统要用RabbitMQ-16.png)

消息消费端：
```
node ./src/consumer.js
```
![](./image/第122章—为什么前端监控系统要用RabbitMQ-17.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-18.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-19.png)

这就是通过 direct 交换机发送消息的过程。

在管理页面上也可以看到这个交换机的信息：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-20.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-21.png)

可以看到，两个消费者分别收到了不同 routing key 对应的消息。

当然，在管理界面这里也是可以发消息的：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-22.png)

消费者端同样可以收到：

![](./image/第122章—为什么前端监控系统要用RabbitMQ-23.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-24.png)
...
![](./image/第122章—为什么前端监控系统要用RabbitMQ-25.png)
