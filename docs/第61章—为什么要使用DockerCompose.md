...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-4.png)

可以看到，执行了 create table 的 sql。

![](http://static.liushuaiyang.com/nest-docs/image/第61章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-6.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-8.png)

![](http://static.liushuaiyang.com/nest-docs/image/第61章-9.png)
...
打印了 redis 里的 key：
![](http://static.liushuaiyang.com/nest-docs/image/第61章-10.png)

在 RedisInsight 里看到的也是这些：

![](http://static.liushuaiyang.com/nest-docs/image/第61章-11.png)
...
docker build -t eee .
```
![](http://static.liushuaiyang.com/nest-docs/image/第61章-12.png)

（我这里稍微有点久，用了 200 多秒）

在 docker desktop 里可以看到这个镜像：

![](http://static.liushuaiyang.com/nest-docs/image/第61章-13.png)

那假设在服务器上，要怎么部署这个 nest 应用呢？

我们先把 mysql、redis 的容器停掉。

![](http://static.liushuaiyang.com/nest-docs/image/第61章-14.png)

![](http://static.liushuaiyang.com/nest-docs/image/第61章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-17.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-18.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第61章-19.png)
```
docker logs redis-container
```

![](http://static.liushuaiyang.com/nest-docs/image/第61章-20.png)

```
docker logs nest-container
```

![](http://static.liushuaiyang.com/nest-docs/image/第61章-21.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-22.png)

然后把 AppModule 里的 redis 和 mysql 连接信息改一下：

![](http://static.liushuaiyang.com/nest-docs/image/第61章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-24.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第61章-25.png)
然后在数据库里把 aaa这个表删掉：

![](http://static.liushuaiyang.com/nest-docs/image/第61章-26.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-27.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-28.png)
...
![image.png](http://static.liushuaiyang.com/nest-docs/image/第61章-29.png)

浏览器访问下 http://localhost:3000

![image.png](http://static.liushuaiyang.com/nest-docs/image/第61章-30.png)

再次 docker logs 看看：

![image.png](http://static.liushuaiyang.com/nest-docs/image/第61章-31.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-32.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-33.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-34.png)

浏览器访问下 http://localhost:3000


![](http://static.liushuaiyang.com/nest-docs/image/第61章-35.png)

可以看到 redis 也连接成功了：

![](http://static.liushuaiyang.com/nest-docs/image/第61章-36.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第61章-37.png)
