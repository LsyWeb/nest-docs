...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-2.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-6.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-15.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-17.png)

输入用户名、密码，点击登录：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-18.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-20.png)

在 postman 里测试下登录接口：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-21.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-23.png)

我们在服务端开启下跨域支持：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-24.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-30.png)

提示登录成功，并且返回了用户信息和 token。

再输入错误的用户名、密码试试：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-31.png)

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-32.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-35.png)

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-36.png)

这样，登录的前后端功能就都完成了。

然后来写下注册：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-37.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-40.png)

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-41.png)

同样，我们先在 postman 里调用下：

调用发送验证码接口：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-42.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-44.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-47.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-50.png)

去邮箱里看一下验证码：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-51.png)

填入验证码，点击注册：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-52.png)
...
![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-57.png)

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-58.png)

测试下：

![](./image/第91章—会议室预订系统：用户管理模块--用户端登录注册页面-59.png)
