...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-3.png)

刷新就可以看到这个刚创建的存储过程：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-4.png)

点击第二个图标就可以传参数调用：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-6.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-7.png)

之后之后再创建 function：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-8.png)

创建成功之后就可以在 sql 里用它了：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-9.png)

比如查询刚才的视图：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第42章-11.png)

你也可以可视化的调用这个 function：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-12.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第42章-13.png)

我们自己来算算对不对：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-14.png)

id 为 3 的订单的总额是对的：

![](http://static.liushuaiyang.com/nest-docs/image/第42章-15.png)
