...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-1.png)

分享出去很不方便。

这时候就可以通过短链服务把它缩短：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-2.png)

点击短链会跳转到原链接：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-3.png)

这种在短信里很常见：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-4.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-6.png)

还可以做一些分析：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-8.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-9.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-11.png)

随机生成 0-61 的数字，然后转成字符。

62 的 6 次方，范围有 580 亿，足够用了：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-13.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-14.png)

先进入项目，把它跑起来：

    npm run start:dev

![](http://static.liushuaiyang.com/nest-docs/image/第78章-15.png)

浏览器看到 hello world，代表 nest 服务跑成功了：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-16.png)

然后我们用 docker 把 mysql 跑起来：

从 docker 官网下载 docker desktop，这个是 docker 的桌面端：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-17.png)

跑起来后，搜索 mysql 镜像（这步需要科学上网），点击 run：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-18.png)

输入容器名、端口映射、以及挂载的数据卷，还要指定一个环境变量：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-20.png)

跑起来后，我们用 GUI 客户端连上，这里我们用的是 mysql workbench，这是 mysql 官方提供的免费客户端：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-21.png)

连接上之后，点击创建 database：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-22.png)

指定名字、字符集为 utf8mb4，然后点击右下角的 apply。

创建成功之后在左侧就可以看到这个 database 了：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-24.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-25.png)

保存之后，TypeORM会自动建表:

![](http://static.liushuaiyang.com/nest-docs/image/第78章-26.png)

![](http://static.liushuaiyang.com/nest-docs/image/第78章-27.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-28.png)

![](http://static.liushuaiyang.com/nest-docs/image/第78章-29.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-30.png)

然后在 service 方法上声明，每 5s 执行一次：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-31.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-32.png)

数据库中也可以看到插入的未使用的压缩码：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-33.png)

当然，一个个这么插入可太费劲了。

我们一般是在凌晨 4 点左右批量插入一堆，比如一次性插入 10000 个。

![](http://static.liushuaiyang.com/nest-docs/image/第78章-34.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-35.png)

同样会自动建表：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-36.png)

![](http://static.liushuaiyang.com/nest-docs/image/第78章-37.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-38.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-39.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-40.png)

可以看到，打印了 4 条 sql：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-41.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-42.png)

![](http://static.liushuaiyang.com/nest-docs/image/第78章-43.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第78章-44.png)
...
![image.png](http://static.liushuaiyang.com/nest-docs/image/第78章-45.png)
...
![image.png](http://static.liushuaiyang.com/nest-docs/image/第78章-46.png)

![2023-12-01 14.32.03.gif](http://static.liushuaiyang.com/nest-docs/image/第78章-47.png)

这样，我们的短链服务就完成了。

其他的非核心功能，比如记录每次访问记录，做一些分析：

![](http://static.liushuaiyang.com/nest-docs/image/第78章-48.png)

![](http://static.liushuaiyang.com/nest-docs/image/第78章-49.png)
