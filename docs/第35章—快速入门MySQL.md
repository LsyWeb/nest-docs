...
![](./image/第35章—快速入门MySQL-1.png)

我们会在命令行客户端或者 GUI 客户端里连接 MySQL，发送 SQL 语句来操作它。

通过 Docker Desktop 查询下 MySQL 的镜像：

![](./image/第35章—快速入门MySQL-2.png)

点击 run，传入参数：

![](./image/第35章—快速入门MySQL-3.png)
...
![](./image/第35章—快速入门MySQL-8.png)

它会让你登录，你可以点下面的 no thanks，直接开始下载：

![](./image/第35章—快速入门MySQL-9.png)

安装包下载后，点击安装。

安装好后，打开 mysql workbench，点击这个 + 号：

![](./image/第35章—快速入门MySQL-10.png)

输入连接名，点击 store in keychain 输入密码：

![](./image/第35章—快速入门MySQL-11.png)

![](./image/第35章—快速入门MySQL-12.png)

之后你可以点击下 Test Connection 测试连接是否成功：

![](./image/第35章—快速入门MySQL-13.png)

然后点击 ok。

之后点击这个连接，进入操作 mysql server 的界面：

![](./image/第35章—快速入门MySQL-14.png)

![](./image/第35章—快速入门MySQL-15.png)

点击 schemas 就可以看到 mysql 现在已有的数据库和它下面的表、视图、存储过程、函数等：

![](./image/第35章—快速入门MySQL-16.png)
...
![](./image/第35章—快速入门MySQL-17.png)

这就是这个表的数据：

![](./image/第35章—快速入门MySQL-18.png)

点击第一个图标，会展示表的信息，比如多少列、多少行、占据了多大的空间等：

![](./image/第35章—快速入门MySQL-19.png)

点击第二个图标是修改表的列的定义的：

![](./image/第35章—快速入门MySQL-20.png)
...
![](./image/第35章—快速入门MySQL-22.png)

输入名字，指定字符集，点击右下角的 apply。

创建成功之后，就可以看到我们刚建的数据库了：

![](./image/第35章—快速入门MySQL-23.png)

选中 hello-mysql 数据库，点击创建 table 的按钮，我们来建个表：

![](./image/第35章—快速入门MySQL-24.png)

输入表名 student。

先建立 id 列：

![](./image/第35章—快速入门MySQL-25.png)
...
![](./image/第35章—快速入门MySQL-33.png)

下面是执行结果，可以看到都插入成功了，一共 3 行。

![](./image/第35章—快速入门MySQL-34.png)

然后再选中上面的查询 sql 来执行：

![](./image/第35章—快速入门MySQL-35.png)

下面也同样会展示查询 sql 的执行情况，一共返回了 4 行数据：

![](./image/第35章—快速入门MySQL-36.png)

新增学会了，修改和删除呢？

我们同样可视化操作一下，然后看看 sql：

![](./image/第35章—快速入门MySQL-37.png)

![](./image/第35章—快速入门MySQL-38.png)
...
![](./image/第35章—快速入门MySQL-39.png)

点击 review sql
![](./image/第35章—快速入门MySQL-40.png)

![](./image/第35章—快速入门MySQL-41.png)

删除是 drop：

![](./image/第35章—快速入门MySQL-42.png)
...
![](./image/第35章—快速入门MySQL-44.png)

这就像我们切到某个目录执行命令一样。

在 mysql workbench 里也是这样，先选中 use xx 那行执行，然后再选中其他 sql 执行。

![](./image/第35章—快速入门MySQL-45.png)
...
![](./image/第35章—快速入门MySQL-46.png)

本地对应的目录也修改了：

![](./image/第35章—快速入门MySQL-47.png)
