...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-3.png)

![](http://static.liushuaiyang.com/nest-docs/image/第16章-4.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-5.png)

这俩适配器分别在 @nestjs/platform-express 和 @nestjs/platform-fastify 的包里：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-6.png)

默认用的是 platform-express 的包：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-8.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-9.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-10.png)

改成这样：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-11.png)

这个 FastifyAdapter 前面讲过，传入这个 adapter 之后，就切换到了 fastify 平台。

这里你还可以再传一个类型参数：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-12.png)

这样返回的 app 就会提示 fastify 平台特有的方法了：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-13.png)

这也是为什么之前我们要传入 NestExpressApplication 才有 useStaticAssets 方法：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-14.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-15.png)

![](http://static.liushuaiyang.com/nest-docs/image/第16章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第16章-17.png)

传个 passthrough 参数，代表不会在方法里自己发送响应内容。

这样返回值就生效了：

![](http://static.liushuaiyang.com/nest-docs/image/第16章-18.png)
