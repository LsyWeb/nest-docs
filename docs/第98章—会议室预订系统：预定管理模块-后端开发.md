...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-1.png)

![](http://static.liushuaiyang.com/nest-docs/image/第98章-2.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第98章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-4.png)

我们在 entities 引入：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-5.png)

typeorm 会自动建表和创建外键：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-6.png)

在 mysql workbench 里可以看到这个表：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-7.png)

这两个外键都是 restrict 的约束：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-8.png)

restrict 是只有从表没有相关记录，才可以删除主表记录。

但我们会议室是支持删除的，怎么办呢？

![](http://static.liushuaiyang.com/nest-docs/image/第98章-9.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-10.png)

在数据库的 booking 表可以看到插入了 4 条记录：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-11.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-12.png)

我们来写一下：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-13.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-14.png)

先看下有啥数据：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-15.png)

![](http://static.liushuaiyang.com/nest-docs/image/第98章-16.png)

![](http://static.liushuaiyang.com/nest-docs/image/第98章-17.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第98章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-19.png)

打印了一堆 sql，下面有查询的结果：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-20.png)

查询出来的是 id 为 1 和 3 的记录。

因为条件是 user.name 包含 guang：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-21.png)

room.name 包含天王：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-22.png)

所以查出这两条是对的：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-24.png)

可以在这里指定 select 的字段：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-25.png)

但这样有点麻烦。

我们直接查出来之后把它删掉就好了：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-26.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-27.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-28.png)

状态有这 4 种：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-29.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第98章-30.png)

```
http://localhost:3005/booking/reject/2
```
![](http://static.liushuaiyang.com/nest-docs/image/第98章-31.png)

```
http://localhost:3005/booking/reject/3
```

![](http://static.liushuaiyang.com/nest-docs/image/第98章-32.png)

在 mysql workbench 里可以看到状态成功被修改了：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-33.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第98章-34.png)

第一次催办，管理员会收到邮件：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-35.png)

第二次催办，会提示半小时只能催办一次：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-36.png)

在 RedisInsight 里可以看到这两个 key：

![](http://static.liushuaiyang.com/nest-docs/image/第98章-37.png)
