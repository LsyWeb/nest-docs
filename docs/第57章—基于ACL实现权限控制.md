...
```
![](./image/第57章—基于ACL实现权限控制-4.png)

刷新可以看到这个 database：

![](./image/第57章—基于ACL实现权限控制-5.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-8.png)
...
npm run start:dev
```
![](./image/第57章—基于ACL实现权限控制-10.png)

可以看到生成了 user、permission、user_permission_relation 这 3 个表。

并且中间表 user_permission_relation 还有 userId、permissionId 两个外键。

![image.png](./image/第57章—基于ACL实现权限控制-11.png)

![image.png](./image/第57章—基于ACL实现权限控制-12.png)

![image.png](./image/第57章—基于ACL实现权限控制-13.png)

![image.png](./image/第57章—基于ACL实现权限控制-14.png)
...
![](./image/第57章—基于ACL实现权限控制-15.png)

服务端打印了一堆 sql，包了一层事务：

![](./image/第57章—基于ACL实现权限控制-16.png)
...
![](./image/第57章—基于ACL实现权限控制-17.png)

user 表插入了 2 条用户记录：

![](./image/第57章—基于ACL实现权限控制-18.png)

中间表插入了 8 条记录，两个用户各拥有 4 个权限：

![](./image/第57章—基于ACL实现权限控制-19.png)
...
![](./image/第57章—基于ACL实现权限控制-20.png)

然后在 postman 里测试下：

ValidationPipe 不通过的时候，会返回错误信息：

![](./image/第57章—基于ACL实现权限控制-21.png)

ValidationPipe 通过之后，就会执行 handler 里的方法：

![](./image/第57章—基于ACL实现权限控制-22.png)

![](./image/第57章—基于ACL实现权限控制-23.png)
...
用户不存在：
![image.png](./image/第57章—基于ACL实现权限控制-24.png)

密码错误：

![image.png](./image/第57章—基于ACL实现权限控制-25.png)

登录成功：
![image.png](./image/第57章—基于ACL实现权限控制-26.png)

![image.png](./image/第57章—基于ACL实现权限控制-27.png)
...
nest g resource bbb 
```
![image.png](./image/第57章—基于ACL实现权限控制-28.png)


![image.png](./image/第57章—基于ACL实现权限控制-29.png)

现在这些接口可以直接访问：

![image.png](./image/第57章—基于ACL实现权限控制-30.png)

![image.png](./image/第57章—基于ACL实现权限控制-31.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-32.png)

利用同名 interface 会自动合并的特点来扩展 Session。

然后给接口都加上这个 Guard：

![image.png](./image/第57章—基于ACL实现权限控制-33.png)

![image.png](./image/第57章—基于ACL实现权限控制-34.png)

再访问下：

![image.png](./image/第57章—基于ACL实现权限控制-35.png)

![image.png](./image/第57章—基于ACL实现权限控制-36.png)

在 postman 里带上 cookie 访问：

![image.png](./image/第57章—基于ACL实现权限控制-37.png)

你访问登录接口之后，服务端返回 set-cookie 的 header，postman 会自动带上 cookie，不需要手动带：

![image.png](./image/第57章—基于ACL实现权限控制-38.png)

行为和浏览器里一致。

这时候再访问 aaa、bbb 的接口，就可以访问了：

![image.png](./image/第57章—基于ACL实现权限控制-39.png)

![image.png](./image/第57章—基于ACL实现权限控制-40.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-41.png)
...
![](./image/第57章—基于ACL实现权限控制-42.png)

然后在 /aaa 的 handler 里添加 PermissionGuard：

![image.png](./image/第57章—基于ACL实现权限控制-43.png)

postman 访问下：

首先重新登录，post 方式请求 /user/login：

![image.png](./image/第57章—基于ACL实现权限控制-44.png)

然后 get 访问 /aaa，postman 会自动带上 cookie。

![image.png](./image/第57章—基于ACL实现权限控制-45.png)

服务端打印了 UserService：

![image.png](./image/第57章—基于ACL实现权限控制-46.png)
...
![](./image/第57章—基于ACL实现权限控制-47.png)

然后请求 /aaa 接口：

![](./image/第57章—基于ACL实现权限控制-48.png)

服务端打印了当前用户的权限信息：

![](./image/第57章—基于ACL实现权限控制-49.png)
...
![](./image/第57章—基于ACL实现权限控制-52.png)
访问 /aaa，会提示没有权限：

![image.png](./image/第57章—基于ACL实现权限控制-53.png)

然后登录东东的账号：

![](./image/第57章—基于ACL实现权限控制-54.png)

然后访问 /aaa：

![](./image/第57章—基于ACL实现权限控制-55.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-56.png)
...
nest g module redis
```
![image.png](./image/第57章—基于ACL实现权限控制-57.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-58.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-59.png)
...
![image.png](./image/第57章—基于ACL实现权限控制-60.png)

然后先登录：

![image.png](./image/第57章—基于ACL实现权限控制-61.png)

服务端打印了查询用户数据的 sql：

![image.png](./image/第57章—基于ACL实现权限控制-62.png)

然后再访问 /aaa

![image.png](./image/第57章—基于ACL实现权限控制-63.png)

又打印了 2 条关联查询的 sql：

![image.png](./image/第57章—基于ACL实现权限控制-64.png)

我们去 RedisInsight 里看下：

![image.png](./image/第57章—基于ACL实现权限控制-65.png)

可以看到这条缓存。

这时候你刷新多少次，都不会再产生 sql 了：

![2023-06-22 17.16.43.gif](./image/第57章—基于ACL实现权限控制-66.png)
