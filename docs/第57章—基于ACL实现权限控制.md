...
![image.png](./image/第57章-11.png)

![image.png](./image/第57章-12.png)

![image.png](./image/第57章-13.png)

![image.png](./image/第57章-14.png)
...
用户不存在：
![image.png](./image/第57章-24.png)

密码错误：

![image.png](./image/第57章-25.png)

登录成功：
![image.png](./image/第57章-26.png)

![image.png](./image/第57章-27.png)
...
nest g resource bbb 
```
![image.png](./image/第57章-28.png)


![image.png](./image/第57章-29.png)

现在这些接口可以直接访问：

![image.png](./image/第57章-30.png)

![image.png](./image/第57章-31.png)
...
![image.png](./image/第57章-32.png)

利用同名 interface 会自动合并的特点来扩展 Session。

然后给接口都加上这个 Guard：

![image.png](./image/第57章-33.png)

![image.png](./image/第57章-34.png)

再访问下：

![image.png](./image/第57章-35.png)

![image.png](./image/第57章-36.png)

在 postman 里带上 cookie 访问：

![image.png](./image/第57章-37.png)

你访问登录接口之后，服务端返回 set-cookie 的 header，postman 会自动带上 cookie，不需要手动带：

![image.png](./image/第57章-38.png)

行为和浏览器里一致。

这时候再访问 aaa、bbb 的接口，就可以访问了：

![image.png](./image/第57章-39.png)

![image.png](./image/第57章-40.png)
...
![image.png](./image/第57章-43.png)

postman 访问下：

首先重新登录，post 方式请求 /user/login：

![image.png](./image/第57章-44.png)

然后 get 访问 /aaa，postman 会自动带上 cookie。

![image.png](./image/第57章-45.png)

服务端打印了 UserService：

![image.png](./image/第57章-46.png)
...
![image.png](./image/第57章-60.png)

然后先登录：

![image.png](./image/第57章-61.png)

服务端打印了查询用户数据的 sql：

![image.png](./image/第57章-62.png)

然后再访问 /aaa

![image.png](./image/第57章-63.png)

又打印了 2 条关联查询的 sql：

![image.png](./image/第57章-64.png)

我们去 RedisInsight 里看下：

![image.png](./image/第57章-65.png)

可以看到这条缓存。

这时候你刷新多少次，都不会再产生 sql 了：

![2023-06-22 17.16.43.gif](./image/第57章-66.png)
