...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-2.png)

可以看到所有接口都列出来了：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-3.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-5.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-7.png)

然后我们一个个接口来看：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-8.png)

先是 /user/register-captcha 接口

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-9.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-10.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-12.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-13.png)

请求体的属性需要去 dto 里标识：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-14.png)

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-15.png)

然后接口文档里就可看到请求体的信息了：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-16.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-19.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-21.png)

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-22.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-28.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-32.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-37.png)
接口文档没啥问题：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-38.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-40.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-42.png)

刷新下，可以看到最新的接口文档：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-43.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-45.png)

没啥问题。

最后，还剩下 /user/list 接口：

![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-46.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-47.png)
...
![](./image/第90章—会议室预订系统：用户管理模块--swagger接口文档-50.png)
