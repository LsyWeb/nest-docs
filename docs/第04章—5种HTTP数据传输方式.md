...
nest new xxx
```
![](./image/第04章—5种HTTP数据传输方式-4.image#?w=942&h=738&s=241806&e=png&b=010101.png)

*   在根目录执行 nest g resource person 快速生成 person 模块的 crud 代码
```
nest g resource person
```
![](./image/第04章—5种HTTP数据传输方式-5.image#?w=834&h=458&s=111235&e=png&b=191919.png)
...
![](./image/第04章—5种HTTP数据传输方式-6.image#?w=1536&h=550&s=228917&e=png&b=181818.png)

这样一个有 person 的 crud 接口的服务就跑起来了。

服务跑起来以后是这样的

![](./image/第04章—5种HTTP数据传输方式-7.png)

打印出了有哪些接口可以用，可以在浏览器测试下：

![](./image/第04章—5种HTTP数据传输方式-8.png)
...
![](./image/第04章—5种HTTP数据传输方式-10.png)
...
![](./image/第04章—5种HTTP数据传输方式-11.png)
...
![](./image/第04章—5种HTTP数据传输方式-12.png)
...
![](./image/第04章—5种HTTP数据传输方式-13.png)
...
![](./image/第04章—5种HTTP数据传输方式-14.png)
...
![](./image/第04章—5种HTTP数据传输方式-15.png)
...
![](./image/第04章—5种HTTP数据传输方式-16.png)
...
![](./image/第04章—5种HTTP数据传输方式-17.png)
...
![](./image/第04章—5种HTTP数据传输方式-18.png)

服务端接收到了 name 和 age：

![](./image/第04章—5种HTTP数据传输方式-19.png)

去服务器控制台看下：

![](./image/第04章—5种HTTP数据传输方式-20.png)

![](./image/第04章—5种HTTP数据传输方式-21.png)
