...
执行它：
![](./image/第40章—SQL综合练习-1.png)

点击刷新，就可以看到这个 database（也叫 schema）了：

![](./image/第40章—SQL综合练习-2.png)
...
![](./image/第40章—SQL综合练习-5.png)

执行建表 sql:

![](./image/第40章—SQL综合练习-6.png)

点击刷新，就可以看到这三个表了：

![](./image/第40章—SQL综合练习-7.png)
...
![](./image/第40章—SQL综合练习-9.png)

```sql
select * from orders
```

![](./image/第40章—SQL综合练习-10.png)

```sql
select * from order_items
```

![](./image/第40章—SQL综合练习-11.png)
...
![](./image/第40章—SQL综合练习-23.png)

再查询下：

![](./image/第40章—SQL综合练习-24.png)
