...
![](./image/第41章—MySQL的事务和隔离级别-1.png)

那总金额就是 200，需要改 order 表的 total\_amount 为 200。

![](./image/第41章—MySQL的事务和隔离级别-2.png)
...
![](./image/第41章—MySQL的事务和隔离级别-3.png)

![](./image/第41章—MySQL的事务和隔离级别-4.png)
...
![](./image/第41章—MySQL的事务和隔离级别-5.png)

你会发现它们的数据恢复了：

![](./image/第41章—MySQL的事务和隔离级别-6.png)

![](./image/第41章—MySQL的事务和隔离级别-7.png)
...
![](./image/第41章—MySQL的事务和隔离级别-8.png)
...
![](./image/第41章—MySQL的事务和隔离级别-9.png)

![](./image/第41章—MySQL的事务和隔离级别-10.png)
...
![](./image/第41章—MySQL的事务和隔离级别-11.png)

![](./image/第41章—MySQL的事务和隔离级别-12.png)

这时候 order\_items 表修改成功了，但是 orders 表修改没成功。

这确实是这个点的状态：

![image.png](./image/第41章—MySQL的事务和隔离级别-13.png)
...
![](./image/第41章—MySQL的事务和隔离级别-14.png)

![](./image/第41章—MySQL的事务和隔离级别-15.png)
...
```
![](./image/第41章—MySQL的事务和隔离级别-16.png)
