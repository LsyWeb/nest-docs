...
![](./image/第38章—一对多、多对多关系的表设计-1.png)

一个订单有多个商品，而商品只属于一个订单。

![](./image/第38章—一对多、多对多关系的表设计-2.png)

一个部门有多个员工，员工只属于一个部门。

![](./image/第38章—一对多、多对多关系的表设计-3.png)

多对多的关系也是随处可见：

一篇文章可以有多个标签，一个标签可以多篇文章都有。

![](./image/第38章—一对多、多对多关系的表设计-4.png)

一个学生可以选修多门课程，一门课程可以被多个学生选修。

![](./image/第38章—一对多、多对多关系的表设计-5.png)

一个用户可以有多个角色，一个角色可能多个用户都有。

![](./image/第38章—一对多、多对多关系的表设计-6.png)
...
![](./image/第38章—一对多、多对多关系的表设计-7.png)

在员工表添加外键 department\_id 来表明这种多对一关系：

![](./image/第38章—一对多、多对多关系的表设计-8.png)

其实和一对一关系的数据表设计是一样的。

我们添加这两个表。

![](./image/第38章—一对多、多对多关系的表设计-9.png)
...
![](./image/第38章—一对多、多对多关系的表设计-10.png)

同样的方式创建 employee 表：

![](./image/第38章—一对多、多对多关系的表设计-11.png)
...
![](./image/第38章—一对多、多对多关系的表设计-12.png)

点击 apply 就创建成功了。

![](./image/第38章—一对多、多对多关系的表设计-13.png)
...
![](./image/第38章—一对多、多对多关系的表设计-14.png)

查询下：

![](./image/第38章—一对多、多对多关系的表设计-15.png)
...
![](./image/第38章—一对多、多对多关系的表设计-16.png)

查询下：

![](./image/第38章—一对多、多对多关系的表设计-17.png)
...
![](./image/第38章—一对多、多对多关系的表设计-18.png)
...
![](./image/第38章—一对多、多对多关系的表设计-19.png)
...
![](./image/第38章—一对多、多对多关系的表设计-20.png)

然后把 id 为 5 的部门删掉：

![](./image/第38章—一对多、多对多关系的表设计-21.png)

点击 apply。

再查看下员工表，可以看到销售部下的 3 个员工的部门被设置为 null 了：

![](./image/第38章—一对多、多对多关系的表设计-22.png)
...
![](./image/第38章—一对多、多对多关系的表设计-23.png)

之前一对多关系是通过在多的一方添加外键来引用一的一方的 id。

![](./image/第38章—一对多、多对多关系的表设计-24.png)

但是现在是多对多了，每一方都是多的一方。这时候是不是双方都要添加外键呢？

一般我们是这样设计：

![](./image/第38章—一对多、多对多关系的表设计-25.png)
...
![](./image/第38章—一对多、多对多关系的表设计-26.png)

查询下：

![](./image/第38章—一对多、多对多关系的表设计-27.png)
...
![](./image/第38章—一对多、多对多关系的表设计-28.png)

再查询下：

![](./image/第38章—一对多、多对多关系的表设计-29.png)
...
![](./image/第38章—一对多、多对多关系的表设计-30.png)
...
![](./image/第38章—一对多、多对多关系的表设计-31.png)

然后查询下：

![](./image/第38章—一对多、多对多关系的表设计-32.png)
...
![](./image/第38章—一对多、多对多关系的表设计-33.png)
...
![](./image/第38章—一对多、多对多关系的表设计-34.png)

![](./image/第38章—一对多、多对多关系的表设计-35.png)
...
![](./image/第38章—一对多、多对多关系的表设计-36.png)
...
![](./image/第38章—一对多、多对多关系的表设计-37.png)

输入 sql 后点击执行。

然后就可以看到插入的数据了：

![](./image/第38章—一对多、多对多关系的表设计-38.png)
...
![](./image/第38章—一对多、多对多关系的表设计-39.png)
...
![](./image/第38章—一对多、多对多关系的表设计-40.png)
...
![](./image/第38章—一对多、多对多关系的表设计-41.png)

然后再执行下面的查询：

![](./image/第38章—一对多、多对多关系的表设计-42.png)

可以看到关系也被级联删除了，这就是 CASCADE 的作用。

当然，删除的只是关系，并不影响 id=1 的标签：

![](./image/第38章—一对多、多对多关系的表设计-43.png)
