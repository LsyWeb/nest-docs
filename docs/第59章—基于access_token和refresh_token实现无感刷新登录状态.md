...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-1.png)

访问接口的时候带上 jwt，在 Guard 里取出来判断是否有效，有效的话才能继续访问：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-3.png)

access_token 用来做登录鉴权：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-4.png)

而 refresh_token 用来刷新，拿到新 token：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-6.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第59章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-8.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-9.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-11.png)

在 mysql workbench 里可以看到 user 表：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-13.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-14.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-17.png)

我们测试一下：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-18.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-19.png)

鉴权逻辑生效了。

然后我们登录下：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-20.png)

把 access_token 复制下来，加到 header 里再访问：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-21.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-22.png)

refresh_token 失效或者错误时，会返回 401 的响应码，提示需要重新登录：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-24.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-25.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-26.png)

可以看到 /aaa 访问成功，返回了数据，/bbb 返回了 401

![](http://static.liushuaiyang.com/nest-docs/image/第59章-27.png)

这里请求两次是因为 index.tsx 里面有个 React.StrictMode，把它去掉就好了：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-28.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-29.png)

我们先登录一下，拿到 access_token，然后在请求的时候带上：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-30.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-31.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-32.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-33.png)

如果很多接口都要添加这个 header，可以把它放在 interceptors 里做：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-34.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-35.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-36.png)
```javascript
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-37.png)

刷新下页面：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-38.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-39.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-40.png)

确实刷新了多次，并发的 3 次，还有后面又访问了一次：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-41.png)

其实这样不处理也行，多刷几次也不影响功能。

但做的完美点还是要处理下：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-42.png)

![](http://static.liushuaiyang.com/nest-docs/image/第59章-43.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第59章-44.png)

现在就只刷新一次 token 了：

![](http://static.liushuaiyang.com/nest-docs/image/第59章-45.png)

最后，为什么说双 token 会更安全呢？

![](http://static.liushuaiyang.com/nest-docs/image/第59章-46.png)
