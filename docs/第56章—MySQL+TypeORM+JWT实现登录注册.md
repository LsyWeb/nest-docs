...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-1.png)

刷新后就可以看到这个数据库了：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-2.png)

然后我们创建个 nest 项目：

    nest new login-and-register -p npm

![](http://static.liushuaiyang.com/nest-docs/image/第56章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-4.png)

引入 User 的 entity：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-6.png)

可以看到打印了 create table 的建表 sql：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-7.png)

用 mysql workbench 可以看到生成的表是对的：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-8.png)

然后我们在 UserModule 引入 TypeOrm.forFeature 动态模块，传入 User 的 entity。

![](http://static.liushuaiyang.com/nest-docs/image/第56章-9.png)

这样模块内就可以注入 User 对应的 Repository 了：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-11.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-12.png)

我们先在 postman 里测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-13.png)

post 请求 /user/login 接口，body 传入用户信息。

服务端打印了收到的 user：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-14.png)

然后 post 请求 /user/register：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-16.png)

我们测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-17.png)

服务返回了注册成功，并且打印了 insert 的 sql：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-18.png)

可以看到，数据库 user 表插入了这个用户的信息，并且指定了 createTime 和 udpateTime。

![](http://static.liushuaiyang.com/nest-docs/image/第56章-19.png)

然后我们再次调用：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-20.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-21.png)

用户名不存在：
![](http://static.liushuaiyang.com/nest-docs/image/第56章-22.png)

用户名存在但密码错误：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-23.png)

可以看到，服务端打印了 3 条 select 的 sql：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-24.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-25.png)

global:true 声明为全局模块，这样就不用每个模块都引入它了，指定加密密钥，token 过期时间。

在 UserController 里注入 JwtService：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-26.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第56章-27.png)

再次访问：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-28.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-29.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-30.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-31.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-32.png)

我们先登录一下，拿到 token：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-33.png)

然后请求 /aaa 的时候通过 authorization 的 header 带上 token：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-34.png)

访问成功。

如果不带 token，就失败了：

![](http://static.liushuaiyang.com/nest-docs/image/第56章-35.png)


![](http://static.liushuaiyang.com/nest-docs/image/第56章-36.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-37.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第56章-38.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-39.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-40.png)

ValidationPipe 生效了。

这样，我们就实现了登录、注册和鉴权的完整功能。

![](http://static.liushuaiyang.com/nest-docs/image/第56章-41.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-42.png)

![](http://static.liushuaiyang.com/nest-docs/image/第56章-43.png)
