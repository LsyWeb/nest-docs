...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-1.png)

![](http://static.liushuaiyang.com/nest-docs/image/第96章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-3.png)

我们已经添加了对应的路由，但是还没做点击菜单时的切换。

加一下：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-4.png)
```javascript
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-6.png)

然后还要加上页面刷新时选中对应菜单项的逻辑：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-8.png)

然后来实现会议室管理页面：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-9.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第96章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-11.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-12.png)

按名称搜索：
![](http://static.liushuaiyang.com/nest-docs/image/第96章-13.png)
按容量搜索：
![](http://static.liushuaiyang.com/nest-docs/image/第96章-14.png)
按设备搜索：
![](http://static.liushuaiyang.com/nest-docs/image/第96章-15.png)

然后，最开始进入页面的时候也得搜索一次：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-17.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-19.png)

提示删除成功，刷新后也确实没有了。

不过应该是删除后自动刷新的。

![](http://static.liushuaiyang.com/nest-docs/image/第96章-20.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-21.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-22.png)

然后实现添加会议室：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-24.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-25.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-26.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-27.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-28.png)
```javascript
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-29.png)

创建成功时：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-30.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-31.png)

![](http://static.liushuaiyang.com/nest-docs/image/第96章-32.png)

测试下：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-33.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-34.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-35.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-36.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-37.png)

然后我们要把 id 传过去：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-38.png)

updateId 的默认值是 undefined，可能为空，加上 ! 代表非空。

然后在组件里添加这个参数：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-39.png)

并且调用查询接口，查询 id 对应的数据来回显：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-40.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-41.png)

然后再加上更新数据的接口：

![](http://static.liushuaiyang.com/nest-docs/image/第96章-42.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第96章-43.png)
