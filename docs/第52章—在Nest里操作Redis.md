...
![](./image/第52章—在Nest里操作Redis-1.png)

最流行的就是 redis 和 ioredis 这两个。

我们创建个项目来试一下：

![](./image/第52章—在Nest里操作Redis-2.png)
...
![](./image/第52章—在Nest里操作Redis-3.png)

然后 node 执行下：

![](./image/第52章—在Nest里操作Redis-4.png)

用 RedisInsight 看下：

![](./image/第52章—在Nest里操作Redis-5.png)
...
![](./image/第52章—在Nest里操作Redis-6.png)

所有的 redis 命令都有对应的方法：

![](./image/第52章—在Nest里操作Redis-7.png)
...
![](./image/第52章—在Nest里操作Redis-8.png)

其他命令也是这样执行：

![](./image/第52章—在Nest里操作Redis-9.png)
...
![](./image/第52章—在Nest里操作Redis-10.png)
...
![](./image/第52章—在Nest里操作Redis-11.png)
...
![](./image/第52章—在Nest里操作Redis-12.png)
...
![](./image/第52章—在Nest里操作Redis-13.png)
