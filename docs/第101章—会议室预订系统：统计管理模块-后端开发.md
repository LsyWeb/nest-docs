...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-1.png)

分别是统计会议室的使用频率、用户的预定频率：

![](http://static.liushuaiyang.com/nest-docs/image/第101章-2.png)

![](http://static.liushuaiyang.com/nest-docs/image/第101章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-4.png)


![](http://static.liushuaiyang.com/nest-docs/image/第101章-5.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第101章-6.png)
...
group by b.roomId;
```
![](http://static.liushuaiyang.com/nest-docs/image/第101章-7.png)

把关联的表换成 meeting_room 就好了。

当然，现在的数据不是很多，我们添加一些数据：

![](http://static.liushuaiyang.com/nest-docs/image/第101章-8.png)

直接通过 mysql workbench 的 copy row 和 paste row 快速复制一些数据就好了。

复制出来的数据要改下 id，以及其他一些信息。

![](http://static.liushuaiyang.com/nest-docs/image/第101章-9.png)

我添加了 4 条数据，并且指定了不同的 userId 和 roomId，点击 apply 应用修改。

然后再跑下那两个统计 sql

![](http://static.liushuaiyang.com/nest-docs/image/第101章-10.png)

![](http://static.liushuaiyang.com/nest-docs/image/第101章-11.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-13.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-14.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-15.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第101章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-17.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第101章-19.png)
