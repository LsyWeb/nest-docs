...
![](./image/第23章—Express如何使用multer实现文件上传-1.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-2.png)

浏览器访问下：

![](./image/第23章—Express如何使用multer实现文件上传-3.png)

这时候在 devtools 可以看到 aaa 请求的 body 是多个 boundary 分隔的格式：

![](./image/第23章—Express如何使用multer实现文件上传-4.png)

而分隔符是在 Content-Type 指定的：

![](./image/第23章—Express如何使用multer实现文件上传-5.png)

这就是 form-data 的传输格式。

然后去服务端看看：

![](./image/第23章—Express如何使用multer实现文件上传-6.png)

req.file 可以拿到文件字段，其余非文件字段在 req.body。

并且服务端多了 uploads 目录，下面就保存着我们上传的文件：

![](./image/第23章—Express如何使用multer实现文件上传-7.png)

单文件上传我们会了，那多文件上传呢？

再添加一个路由处理多文件的上传：

![](./image/第23章—Express如何使用multer实现文件上传-8.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-9.png)

node 服务的 req.files 接收到了多个文件：

![](./image/第23章—Express如何使用multer实现文件上传-10.png)

并且 uploads 目录下也多了俩文件：

![](./image/第23章—Express如何使用multer实现文件上传-11.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-12.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-13.png)

可以看到服务端打印了报错：

![](./image/第23章—Express如何使用multer实现文件上传-14.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-15.png)

![](./image/第23章—Express如何使用multer实现文件上传-16.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-17.png)

服务端收到了 aaa 和 bbb 的文件：

![](./image/第23章—Express如何使用multer实现文件上传-18.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-19.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-20.png)
...
![](./image/第23章—Express如何使用multer实现文件上传-21.png)

我们用时间戳 Date.now() 加上Math.random() 乘以 10 的 9 次方，然后取整，之后加上原来的文件名。

测试下：

![](./image/第23章—Express如何使用multer实现文件上传-22.png)

然后浏览器再次上传：

![](./image/第23章—Express如何使用multer实现文件上传-23.png)

就可以看到目录和文件名都修改了：
![](./image/第23章—Express如何使用multer实现文件上传-24.png)
