...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-1.png)

![](http://static.liushuaiyang.com/nest-docs/image/第73章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-3.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-4.png)

开启后可以在设置里看到：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-5.png)

然后在帮助中心页面搜索授权码：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-6.png)

按照指引生成一个授权码：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-7.png)

这个是 qq 邮箱特有的一个第三方登录密码：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-8.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-9.png)

可以看到邮件发送成功了。

我们在邮箱里看看：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-10.png)

确实收到了这个邮件：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-11.png)

这样我们就用 node 发送了第一个邮件！

而且邮件是支持 html + css 的，比如把我之前写的一个 [3 只小鸟的 button 的 html](https://juejin.cn/post/7167355169934409758) 拿过来：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-12.png)

放到一个文件里，然后发邮件的时候读取这个文件：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-13.png)

然后再跑下：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-14.png)

收到的邮件也渲染出了这个 html，并且 css 动画也是正常的：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-17.png)

可以看到打印了搜索出的符合条件的邮件的 id，然后我们来处理下这些 id：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-20.png)

日期也确实都是 7 月 10 日的。

我邮箱里有这样一个邮件：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-21.png)

可以看到，附件也下载到了 files 目录下：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-22.png)

我们把 html 的内容保存到本地文件里：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-23.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-24.png)

在邮箱里可以看到也是这些邮件：

![](http://static.liushuaiyang.com/nest-docs/image/第73章-25.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第73章-26.png)

![](http://static.liushuaiyang.com/nest-docs/image/第73章-27.png)
