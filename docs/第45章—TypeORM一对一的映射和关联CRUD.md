...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-1.png)

点击刷新，就可以看到这个新的 database 了：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-2.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-3.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-4.png)

点击刷新，在 workbench 里也可以看到这个新建的表：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-5.png)

点击新建 sql，执行 select，也是可以看到插入的数据的：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-6.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-7.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-8.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-9.png)

重新 npm run start：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-10.png)

可以看到生成了这条建表 sql。

workbench 里也可以看到这个表：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-11.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-12.png)

在 IdCard 的 Entity 添加一个 user 列，指定它和 User 是 @OneToTone 一对一的关系。

还要指定 @JoinColum 也就是外键列在 IdCard 对应的表里维护：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-13.png)

重新 npm run start：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-14.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-15.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-16.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-17.png)

生成的表都是对的。

但是这个级联关系还是默认的：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-18.png)

如果我们想设置 CASCADE 应该怎么做呢？

在第二个参数指定：

![image.png](./image/第45章—TypeORM一对一的映射和关联CRUD-19.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-20.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-21.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-28.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-29.png)

再跑一下：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-30.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-31.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-32.png)

再来试下修改：

现在数据是这样的：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-33.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-34.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-35.png)

![](./image/第45章—TypeORM一对一的映射和关联CRUD-36.png)

看下生成的 sql：

![](./image/第45章—TypeORM一对一的映射和关联CRUD-37.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-38.png)
...
![](./image/第45章—TypeORM一对一的映射和关联CRUD-39.png)
