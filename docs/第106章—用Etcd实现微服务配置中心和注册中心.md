...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-3.png)

答案也是需要一个单独的服务来管理，这个服务就是注册中心：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-4.png)
...
这个：
![](http://static.liushuaiyang.com/nest-docs/image/第106章-5.png)

这个：
![](http://static.liushuaiyang.com/nest-docs/image/第106章-6.png)

或者这个：
![](http://static.liushuaiyang.com/nest-docs/image/第106章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-8.png)

它其实是一个 key-value 的存储服务。

k8s 就是用它来做的注册中心、配置中心：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-9.png)

我们通过 docker 把它跑起来。

在 docker desktop 搜索 etcd 的镜像，点击 run:

![](http://static.liushuaiyang.com/nest-docs/image/第106章-10.png)

![](http://static.liushuaiyang.com/nest-docs/image/第106章-11.png)

输入容器名，映射 2379 端口到容器内的 2379 端口，设置 ETCD_ROOT_PASSWORD 环境变量，也就是指定 root 的密码。

然后就可以看到 etcd server 的 docker 镜像成功跑起来了：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-13.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第106章-14.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第106章-15.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-17.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-18.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-20.png)

确实取到了 etcd server 中的值。

然后在 etcdctl 里 put 修改下 /services/a 的值：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-21.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-22.png)

再 del 试下：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-23.png)
```
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-24.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-25.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第106章-26.png)

当在 etcdctl 里 del 一个服务节点的时候，这里也能收到通知：

![](http://static.liushuaiyang.com/nest-docs/image/第106章-27.png)
```
etcdctl del /services/my_service/instance_2
```

![](http://static.liushuaiyang.com/nest-docs/image/第106章-28.png)
