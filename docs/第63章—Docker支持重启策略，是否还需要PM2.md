...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-1.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-2.png)
...
```
![](http://static.liushuaiyang.com/nest-docs/image/第63章-3.png)

在 docker desktop 里可以看到：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-4.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-5.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-6.png)

打印了很多次错误日志：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-7.png)

你可以点击停止，就不会再重启了：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-8.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-9.png)

![](http://static.liushuaiyang.com/nest-docs/image/第63章-10.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-11.png)

这时候你会发现容器一直是运行状态，但是内部的进程一直在重启：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-12.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-13.png)

可以看到容器重启了 2 次，一共打印了 3 次错误就不再重启了：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-14.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-15.png)

可以看到容器一直在重启：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-16.png)

除非点击停止按钮，也就是执行 docker stop 才会停止：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-17.png)

```
docker stop restart-test-container5
```
![](http://static.liushuaiyang.com/nest-docs/image/第63章-18.png)


![](http://static.liushuaiyang.com/nest-docs/image/第63章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第63章-20.png)

这俩容器都停掉了。

现在我们重启 Docker：

![image.png](http://static.liushuaiyang.com/nest-docs/image/第63章-21.png)

他会重启跑 Docker Engine ，也就是 Docker Deamon 的后台进程。

![image.png](http://static.liushuaiyang.com/nest-docs/image/第63章-22.png)

这时候你会发现，always 重启策略的容器又跑起来了，而 unless-stopped 的容器没有重启。这就是这俩的区别：

![image.png](http://static.liushuaiyang.com/nest-docs/image/第63章-23.png)

Docker Compose 是用于同时跑多个 Docker 容器的，它自然也支持 restart 的配置：

![](http://static.liushuaiyang.com/nest-docs/image/第63章-24.png)
