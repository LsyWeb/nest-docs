...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-1.png)

对应的路由我们前面写过了：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-2.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-3.png)

根据这个指定表格列的定义，并且添加分页的处理。

其中涉及到的 User 和 Room 的类型从其他页面导入：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-4.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-5.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-6.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-7.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-8.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-9.png)

数据库里就这 4 条记录：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-10.png)

然后带上参数搜索下：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-11.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-12.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-13.png)

开始时间在 2023-9-29 的 10 点到 11 点的预定有 3 条：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-14.png)

11 点到 12 点的有 1 条：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-15.png)

这样，列表功能就完成了。

可以再加上个按照状态过滤，这个是 antd 的功能：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-16.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-17.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-18.png)

然后加上右边的按钮：

![](http://static.liushuaiyang.com/nest-docs/image/第99章-19.png)
...
![](http://static.liushuaiyang.com/nest-docs/image/第99章-20.png)

![](http://static.liushuaiyang.com/nest-docs/image/第99章-21.png)
