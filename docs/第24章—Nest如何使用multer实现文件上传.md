...
```
![](./image/第24章—Nest如何使用multer实现文件上传-1.image#?w=928&h=658&s=268268&e=png&b=010101.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-2.png)

然后来写前端代码。

之前我们用过这种方式：

![](./image/第24章—Nest如何使用multer实现文件上传-3.image#?w=1102&h=434&s=101648&e=png&b=1f1f1f.png)

就是让 nest 服务支持静态文件的访问。

现在我们换种方式，让 nest 服务支持跨域，再单独跑个 http-server 来提供静态服务：

![](./image/第24章—Nest如何使用multer实现文件上传-4.png)

![](./image/第24章—Nest如何使用multer实现文件上传-5.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-6.png)

服务端就打印了 file 对象，并且文件也保存到了 uploads 目录：

![](./image/第24章—Nest如何使用multer实现文件上传-7.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-8.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-9.png)

后端收到了上传的 aaa、bbb 的文件：

![](./image/第24章—Nest如何使用multer实现文件上传-10.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-11.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-12.png)

![](./image/第24章—Nest如何使用multer实现文件上传-13.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-14.png)

在 FileInterceptor 里也是一样：

![](./image/第24章—Nest如何使用multer实现文件上传-15.png)

在 multer 里我们是通过 array 方法来处理多个 file 的字段：

![](./image/第24章—Nest如何使用multer实现文件上传-16.png)

在 FilesInterceptor 里也一样：

![](./image/第24章—Nest如何使用multer实现文件上传-17.png)

另外两个装饰器也是同理：

![](./image/第24章—Nest如何使用multer实现文件上传-18.png)

![](./image/第24章—Nest如何使用multer实现文件上传-19.png)

而 UploadedFile、UploadedFiles 这些装饰器，只是从 request 中取出处理完的 file、files 等属性作为参数传入 handler：

![](./image/第24章—Nest如何使用multer实现文件上传-20.png)

了解了这些装饰器的原理之后，回头再来看这些文件上传用的装饰器，是不是就很清晰了呢：

![](./image/第24章—Nest如何使用multer实现文件上传-21.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-22.png)

然后访问下：

![](./image/第24章—Nest如何使用multer实现文件上传-23.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-24.png)

可以看到，返回的也是 400 响应，并且 message 说明了具体的错误信息。

而且这个错误信息可以自己修改：

![](./image/第24章—Nest如何使用multer实现文件上传-25.png)

![](./image/第24章—Nest如何使用multer实现文件上传-26.png)
...
![](./image/第24章—Nest如何使用multer实现文件上传-27.png)

在浏览器上传个文件：

![](./image/第24章—Nest如何使用multer实现文件上传-28.png)
