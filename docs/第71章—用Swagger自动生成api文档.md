...
![](./image/第71章—用Swagger自动生成api文档-5.png)
...
![](./image/第71章—用Swagger自动生成api文档-7.png)
...
![](./image/第71章—用Swagger自动生成api文档-8.png)
...
![](./image/第71章—用Swagger自动生成api文档-10.png)

点击 try it out 和 execute，就可以看到发送了请求并返回了响应：

![](./image/第71章—用Swagger自动生成api文档-11.png)
...
![](./image/第71章—用Swagger自动生成api文档-13.png)
...
![](./image/第71章—用Swagger自动生成api文档-15.png)
...
![](./image/第71章—用Swagger自动生成api文档-18.png)
...
![](./image/第71章—用Swagger自动生成api文档-22.png)
```javascript
...
![](./image/第71章—用Swagger自动生成api文档-25.png)

其中 bbb 是没有 * 的，代表可不传。

上面的接口部分也有了请求和响应的示例：

![](./image/第71章—用Swagger自动生成api文档-26.png)
...
![](./image/第71章—用Swagger自动生成api文档-32.png)

![](./image/第71章—用Swagger自动生成api文档-33.png)

比如把 aaa、bbb 接口分到 xxx-get 的组。

那显示的时候就会把这俩接口分出来：

![](./image/第71章—用Swagger自动生成api文档-34.png)
...
![](./image/第71章—用Swagger自动生成api文档-36.png)

![](./image/第71章—用Swagger自动生成api文档-37.png)


![](./image/第71章—用Swagger自动生成api文档-38.png)

然后在 main.ts 里添 3 种认证方式的信息：

![](./image/第71章—用Swagger自动生成api文档-39.png)
...
![](./image/第71章—用Swagger自动生成api文档-43.png)
...
![](./image/第71章—用Swagger自动生成api文档-45.png)

而 basic 的方式，会要求你输入用户名密码：

![](./image/第71章—用Swagger自动生成api文档-46.png)

请求时会带上 Authorization： Basic xxx 的 header 来访问。

![](./image/第71章—用Swagger自动生成api文档-47.png)
...
![](./image/第71章—用Swagger自动生成api文档-49.png)
